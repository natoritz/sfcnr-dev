...
#define CP_HOSPITAL_LV 				( 13 )
#define CP_FIGHTSTYLE_LV 			( 14 )
#define CP_HOSPITAL1_LS 			( 15 )
#define CP_HOSPITAL2_LS 			( 16 )
#define CP_FIGHTSTYLE_LS 			( 17 )
#define CP_PAWNSHOP 				( 18 )
#define CP_HOSPITAL_FC 				( 19 )
#define CP_REFILL_AMMO				( 20 )
#define CP_REFILL_AMMO_LS			( 21 )
#define CP_REFILL_AMMO_LV			( 22 )
#define CP_DROP_OFF_COP           	( 23 )
#define CP_DROP_OFF_FC				( 24 )
#define CP_DROP_OFF_DILLIMORE		( 25 )
#define CP_DROP_OFF_DIABLO			( 26 )
#define CP_DROP_OFF_QUBRADOS		( 27 )
#define CP_DROP_OFF_COP_LS 			( 28 )
#define CP_DROP_OFF_FBI_LS 			( 29 )
#define CP_DROP_OFF_FBI_LV 			( 30 )
#define CP_DROP_OFF_COP_LV 			( 31 )
#define CP_DROP_OFF_FBI             ( 32 )
#define CP_DROP_OFF_HELI         	( 33 )
#define CP_BIZ_TERMINAL_COKE		( 34 )
#define CP_BIZ_TERMINAL_METH 		( 35 )
#define CP_BIZ_TERMINAL_WEED 		( 36 )
#define CP_BIZ_TERMINAL_WEAP 		( 37 )
#define CP_REWARDS_4DRAG 	 		( 38 )
#define CP_REWARDS_CALIG 	 		( 39 )
#define CP_REWARDS_VISAGE 			( 40 )
#define CP_AIRPORT_SF 				( 41 )
#define CP_AIRPORT_LS 				( 42 )
#define CP_AIRPORT_LV 				( 43 )
#define CP_CASINO_BAR 				( 44 )
#define CP_ALCATRAZ_EXPORT			( 45 )
